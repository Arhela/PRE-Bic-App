...
class SchEventTableViewController: UITableViewController {
    ...
    */
    ...
    private func LoadEventList ()
    {
        ...
        let satHeader = SchEvent(name: "Saturday May 08", discription: "Saturday Events", location: "Open Gates", time: "Sat May 08 7:30AM - 5:30PM", speaker: "N/a")
       ...
       //-----------------------------------------------------------------------------------------------------------
        // Sunday Events
        let sunHeader = SchEvent(name: "Sunday May 09", discription: "Sunday Events", location: "Open Gates", time: "Sun May 09 7:30AM - 10:00PM", speaker: "N/a")
        
        let event21 = SchEvent(name: "Derek Wildman, PhD", discription: "Derek Wildman, PhD", location: "Open Gates", time: "Sun May 09 8:30AM - 8:50AM", speaker: "Derek Wildman")
        
        let event22 = SchEvent(name: "George Saade, MD", discription: "George Saade, MD", location: "Open Gates", time: "Sun May 09 8:50AM - 9:10AM", speaker: "George Saade, MD")
        
        let event23 = SchEvent(name: "Q & A", discription: "Q & A", location: "Open Gates", time: "Sun May 09 9:10AM - 9:15AM", speaker: "TBD")
        
        let event24 = SchEvent(name: "Preterm birth research in India", discription: "Preterm birth research in India", location: "Open Gates", time: "Sun May 09 9:15AM - 9:25AM", speaker: "Pallavi Kshetrapal, PhD")
        
         let event25 = SchEvent(name: "Preterm birth research in Africa", discription: "Preterm birth research in Africa", location: "Open Gates", time: "Sun May 09 9:25AM - 9:35AM", speaker: "Samuel Obed, MD")
        
        let event26 = SchEvent(name: "Preterm birth research in East Asia", discription: "Preterm birth research in East Asia", location: "Open Gates", time: "Sun May 09 9:35AM - 9:45AM", speaker: "Kim Young Ju, MD, PhD")
        
        let event27 = SchEvent(name: "Q & A", discription: "Q & A", location: "Open Gates", time: "Sun May 09 9:45AM - 10:00AM", speaker: "N/a")
        
        let event28 = SchEvent(name: "Coffee Break", discription: "Coffee Break", location: "Open Gates", time: "Sun May 09 10:00AM - 10:30AM", speaker: "N/a")
        
        let event29 = SchEvent(name: "Development of young investigator", discription: "Development of young investigator", location: "Open Gates", time: "Sun May 09 10:30AM - 10:40AM", speaker: "Indira Mysorekar")
        
        let event30 = SchEvent(name: "Journal of Preterm Birth", discription: "Journal of Preterm Birth", location: "Open Gates", time: "Sun May 09 10:40AM - 10:50AM", speaker: "Scott M Williams, PhD")
        
         let event31 = SchEvent(name: "PREBIC Book", discription: "PREBIC Book", location: "Open Gates", time: "Sun May 09 10:50AM - 11:00AM", speaker: "Ronnie Lamont, MD")
