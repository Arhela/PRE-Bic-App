...
class Main_Travel_ViewController: UIViewController {
    ...
    */
    ...
    // new Buton actions after change 
    
    @IBAction func newDirFromIAHToGalvez(_ sender: Any)
    {
    ...
    @IBAction func newDirFromHobbyToGalvez(_ sender: Any)
    {
    ...
    @IBAction func newSuperShuttleLink(_ sender: Any)
    {
    ...
    @IBAction func newTaxiLink(_ sender: Any)
    {
    ...
    @IBAction func newGalvezLimoLink(_ sender: Any)
    {
